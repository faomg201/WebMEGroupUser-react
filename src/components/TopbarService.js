...
export const TopbarService = () => {
  ...
  return (
    <div>      
      <ul class="nav marginTopService ">
        <li class="nav-item">
          <a class="nav-link hoverBarBgWhite" onClick={() => {isLink('')}}>หน้าแรก</a>
        </li>
        <li class="nav-item">
            <a class="nav-link hoverBarBgWhitebord" onClick={() => {isLink('serve')}}>บริการ</a> 
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
            <a class="nav-link hoverBarBgWhite" onClick={() => {isLink('contact')}}>ติดต่อเรา</a>
        </li>
